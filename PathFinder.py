...
class BFSPathFinder(PathFinder):
    def find_path(self, start: Tuple[int, int], goal: Tuple[int, int]) -> Optional[List[Tuple[int, int]]]:
        ...
        while frontier:
            ...
            self.visualize_step(current, 'Breadth first Search', 'Level 1: Basic')
...
class DFSPathFinder(PathFinder):
    def find_path(self, start: Tuple[int], goal: Tuple[int]) -> List[Tuple[int]] | None:
        ...
        while stack:
            ...
            self.visualize_step(current, 'Depth-first Search', 'Level 1: Basic')
...
class UCSPathFinder(PathFinder):
    def find_path(self, start: Tuple[int, int], goal: Tuple[int, int]) -> Optional[List[Tuple[int, int]]]:
        ...
        while not frontier.empty():
            ...
            self.visualize_step(current, 'Uniform-cost Search', 'Level 1: Basic')
...
class GBFSPathFinder(PathFinder):
    def find_path(self, start: Tuple[int, int], goal: Tuple[int, int]) -> Optional[List[Tuple[int, int]]]:
        ...
        while not frontier.empty():
            current = frontier.get()
            self.visualize_step(current, 'Greedy best first Search', 'Level 1: Basic')
